              ...
              {todos.map((todo) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 z-10 p-1.5 rounded-md text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors opacity-100 lg:opacity-0 lg:group-hover:opacity-100"
