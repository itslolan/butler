...
Please provide a detailed analysis with specific recommendations.`;
  ...
  const BudgetCTAPanel = () => (
    <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-4 shadow-sm h-full flex flex-col">
  ...
  const AccountsPanel = () => (
    <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-sm h-full">
      <ConnectedAccounts 
