    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <PlaidLinkButton
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 text-xs bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:opacity-50"
        >
      ...
      {institutions.length === 0 && (
        <div className="space-y-2.5">
          {/* Plaid empty state */}
          <div className="p-3 bg-slate-50 dark:bg-gray-800 rounded-lg border border-dashed border-slate-300 dark:border-slate-700 text-center">
            <svg className="w-6 h-6 mx-auto text-slate-400 dark:text-slate-600 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="flex items-center gap-1 text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors mx-auto"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
