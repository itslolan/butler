...
export default function ConnectedAccounts({ onSyncComplete }: ConnectedAccountsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {institutions.length === 0 && (
        <div className="p-6 bg-slate-50 dark:bg-gray-800 rounded-xl border border-dashed border-slate-300 dark:border-slate-700 text-center">
